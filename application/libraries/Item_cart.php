...
class Item_cart {
	...
	public function __construct($params = array())
	{
		...
		$this->_cart_contents = $this->CI->session->userdata('item_cart_contents');
	...
	protected function _save_cart()
	{
		...
		{
			$this->CI->session->unset_userdata('item_cart_contents');
		...
		$this->CI->session->set_userdata(array('item_cart_contents' => $this->_cart_contents));
